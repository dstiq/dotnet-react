...
const dataExample = [
    {
        [columnsIndexName.DATE]: 'Ahmed',
        [columnsIndexName.EARNINGS]: 'Tomi',
        [columnsIndexName.PRECIOUS_METALS]: 'ah@smthing.co.com',
        [columnsIndexName.MMVB]: 'ah@smthing.co.com'
    },
    {
        [columnsIndexName.DATE]: 'Raed',
        [columnsIndexName.EARNINGS]: 'Labes',
        [columnsIndexName.PRECIOUS_METALS]: 'rl@smthing.co.com',
        [columnsIndexName.MMVB]: 'ah@smthing.co.com'
    },
    {
        [columnsIndexName.DATE]: 'Yezzi',
        [columnsIndexName.EARNINGS]: 'Min l3b',
        [columnsIndexName.PRECIOUS_METALS]: 'ymin@cocococo.com',
        [columnsIndexName.MMVB]: 'ah@smthing.co.com'
    }
];
